...
DATA->Draw("3.7800295878-(3.735959e-4*X1posC)-(-1.580282482e-8*X1posC*X1posC)>>hEx",CUTbasic && CUTflags && CUTlimits && CUTy,"");
DATA->Draw("3.7800295878-(3.735959e-4*X1posC)-(-1.580282482e-8*X1posC*X1posC)>>hExback2",CUTbasic && CUTflags && CUTlimits && CUTyback2,"");
DATA->Draw("3.7800295878-(3.735959e-4*X1posC)-(-1.580282482e-8*X1posC*X1posC)>>hExback1",CUTbasic && CUTflags && CUTlimits && CUTyback1,"");
...
hExdiff->Add(hEx);
hExdiff->Add(hExback1);//,-0.416667);
hExdiff->Add(hExback2);//,-0.416667);
