...
hExdiff->SetTitle("^{58}Ni(#alpha,#alpha') at 0^{o} (background subtracted)"); //figure out how to insert alpha,alpha'
hExdiff->SetStats(0);
...
hExdiff->Add(hEx);
hExdiff->Add(hExback1,-1.42857);
hExdiff->Add(hExback2,-1.42857);
hExbacktot->Add(hExback1,1.42857);
hExbacktot->Add(hExback2,1.42857);
