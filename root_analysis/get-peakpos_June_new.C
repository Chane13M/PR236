{
  ...
  //PR260, 0degr, 24Mg
  //Int_t run_no[]={1041,1045,1051,1084,1090,1094,1099,1105,1112,1117,1123,1128,1133,1138,1144,1149,1165};
...
/*
  //PR260, 0 degr, 44Ca
  Int_t run_no[]={1043,1037,1038,1048,1054,1087,1092,1097,1102,1107,1114,1115,1120,1126,1131,1136,1141,1147};
...
*/
  ...
  //PR260, 0 degr, 42Ca
  //Int_t run_no[]={1039,1044,1049,1050,1089,1093,1098,1103,1108,1116,1122,1127,1132,1137,1143,1148};  //1142 too short to care about
  //Int_t run_no[]={1050};
...
*/
  ...
  Double_t fitgaushi=655.5;   // to define range where gauss fitting is done
  Double_t fitcombinedlow=649;    // range over which fitting is performed
  Double_t fitcombinedhi=656;	  // range over which fitting is performed
  Double_t rangelow=fitcombinedlow;    // range of TF1 fit
  Double_t rangehi=fitcombinedhi;     // range of TF1 fit

  //this was also uncommented
  Int_t run_no[]={1128};
