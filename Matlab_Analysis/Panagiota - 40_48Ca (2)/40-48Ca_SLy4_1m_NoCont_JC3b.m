...
ylim([0 12]);
ylabel('d^2\sigma/d\OmegadE (mb/srMeV)','FontSize',12);
...
%xlabel('Excitation energy (MeV)');
title('Retief 48Ca(p,p\prime)   E_{Lab} = 200 MeV');
text(13,10,'Birkhan 48Ca','FontSize',11,'Color','blue');
hold on;
...
text(13,125,'RCNP','FontSize',11,'Color','red');
text(13,105,'N = 0.7','FontSize',11,'Color','black');
hold on;
...
subplot(4,2,3); stairs(ex_12_24_10keV,Ca44_cs_12_24_10keV+1.7,'linewidth',0.25,'Color','black'); axis tight;

set(gca,'TickLength',[0.03 0.03]);
ylim([0 12]);
ylabel('d^2\sigma/d\OmegadE (mb/srMeV)','FontSize',12);
%xlabel('Excitation energy (MeV)');
title('Retief 44Ca(p,p\prime)  + 1.7 (mb/srMeV)');
text(13,10,'Birkhan 48Ca','FontSize',11,'Color','blue')
hold on;
...
for x=1:1201
    Ca44_Eg_12_24_10keV(x)=(Ca44_cs_12_24_10keV(x)+1.7-Ca48_Bk(x))*ex_12_24_10keV(x)/Ca48_V1_12_24_10keV(x);
end
...
text(13,125,'Erokhova','FontSize',11,'Color','red');
text(13,105,'N = 0.7','FontSize',11,'Color','black');
hold on;

fname='44Ca_sigma_abs_Erokhova_2003.dat'

[ex_src,fname_taken]=read_dat(fname,1); % take 1st column
[cnts_src,fname_taken]=read_dat(fname,2); % take 2nd column

Ca44_Ga=cnts_src; % O'Keefe 48Ca(g,abs)
ex_Ca44_Ga=ex_src;

subplot(4,2,4); scatter(ex_Ca44_Ga,Ca44_Ga,10,[1 0 0],'filled'); axis tight;
ylim([0 150]);
xlim([12 24]);
hold off;
...
subplot(4,2,5); stairs(ex_12_24_10keV,Ca42_cs_12_24_10keV+0.4,'linewidth',0.25,'Color','black'); axis tight;

set(gca,'TickLength',[0.03 0.03]);
ylim([0 12]);
ylabel('d^2\sigma/d\OmegadE (mb/srMeV)','FontSize',12);
%xlabel('Excitation energy (MeV)');
title('Retief 42Ca(p,p\prime)  + 0.4 (mb/srMeV)');
text(13,10,'Birkhan 48Ca','FontSize',11,'Color','blue')
hold on;
...
for x=1:1201
    Ca42_Eg_12_24_10keV(x)=(Ca42_cs_12_24_10keV(x)+0.4-Ca48_Bk(x))*ex_12_24_10keV(x)/Ca48_V1_12_24_10keV(x);
end
...
fname='42Ca_sigma_abs_Erokhova_2003.dat'

[ex_src,fname_taken]=read_dat(fname,1); % take 1st column
[cnts_src,fname_taken]=read_dat(fname,2); % take 2nd column

Ca42_Ga=cnts_src; % O'Keefe 48Ca(g,abs)
ex_Ca42_Ga=ex_src;

subplot(4,2,6); scatter(ex_Ca42_Ga,Ca42_Ga,10,[1 0 0],'filled'); axis tight;
ylim([0 150]);
xlim([12 24]);
hold off;
...
figure (730);
subplot(4,2,7); stairs(ex_12_24_10keV,Ca40_cs_12_24_10keV+2.3,'linewidth',0.25,'Color','black'); axis tight;

set(gca,'TickLength',[0.03 0.03]);
ylim([0 12]);
ylabel('d^2\sigma/d\OmegadE (mb/srMeV)','FontSize',12);
xlabel('Excitation energy (MeV)','FontSize',14);
title('Max 40Ca(p,p\prime)  + 2.3 (mb/srMeV)');
text(13,10,'Birkhan 48Ca','FontSize',11,'Color','blue')
hold on;
...
%    Ca48_Bk(x)=1.0+x*(1/1201);
    Ca40_Eg_12_24_10keV(x)=(Ca40_cs_12_24_10keV(x)+2.3-Ca48_Bk(x))*ex_12_24_10keV(x)/Ca48_V1_12_24_10keV(x);
end
...
text(13,125,'Ahrens','FontSize',11,'Color','red');
text(13,105,'N = 0.7','FontSize',11,'Color','black');
hold on;

fname='40Ca_sigma_abs_Ahrens.dat'

[ex_src,fname_taken]=read_dat(fname,1); % take 1st column
[cnts_src,fname_taken]=read_dat(fname,2); % take 2nd column

Ca40_Ga=cnts_src; % O'Keefe 48Ca(g,abs)
ex_Ca40_Ga=ex_src;

subplot(4,2,8); scatter(ex_Ca40_Ga,Ca40_Ga,10,[1 0 0],'filled'); axis tight;
ylim([0 150]);
xlim([12 24]);
hold off;
...
ex_12_24_10keV(1:1201)=ex_src(1:1201)/1000; % ecitation energy in MeV
Ca48_cs_12_24_10keV(1:1201)=cnts_src(1:1201); % Retief 48Ca(p,p') cross-section (mb/sr MeV)
...
%xlabel('Excitation energy (MeV)');
title('Retief 48Ca(p,p\prime)   E_{Lab} = 200 MeV');
text(13,10,'DWT 48Ca','FontSize',11,'Color','green');
hold on;
...
Ca48_V1_12_24_10keV(1:1201)=cnts_src(1:1201); % Virtual1 40Ca


% Determine background 48Ca from DWT analysis - quasi-free and other multipoles

fname='48Ca_DWT_11-25MeV.dat'

[ex_src,fname_taken]=read_dat(fname,1); % take 1st column
[cnts_src,fname_taken]=read_dat(fname,2); % take 2nd column
 
ex_DWT_11_25(1:15)=ex_src(1:15) % DWT 48Ca excitation energy
Ca48_DWT_11_25(1:15)=cnts_src(1:15); % DWT 48Ca
...
ex_DWT_12_24_10keV=12:0.010:24;
Ca48_DWT_12_24_10keV=spline(ex_DWT_11_25,Ca48_DWT_11_25,ex_DWT_12_24_10keV);

subplot(4,2,1); plot(ex_DWT_12_24_10keV,Ca48_DWT_12_24_10keV,'linewidth',1.8,'Color','green'); axis tight;
ylim([0 12]);
xlim([12 24]);
hold off;
...
for x=1:1201   
    Ca48_Eg_12_24_10keV(x)=(Ca48_cs_12_24_10keV(x)-Ca48_DWT_12_24_10keV(x))*ex_12_24_10keV(x)/Ca48_V1_12_24_10keV(x);
end
...
subplot(4,2,3); stairs(ex_12_24_10keV,Ca44_cs_12_24_10keV+1.2,'linewidth',0.25,'Color','black'); axis tight;

set(gca,'TickLength',[0.03 0.03]);
ylim([0 12]);
ylabel('d^2\sigma/d\OmegadE (mb/srMeV)','FontSize',12);
%xlabel('Excitation energy (MeV)');
title('Retief 44Ca(p,p\prime)  + 1.2 (mb/srMeV)');
text(13,10,'DWT 48Ca','FontSize',11,'Color','green')
hold on;


subplot(4,2,3); plot(ex_DWT_12_24_10keV,Ca48_DWT_12_24_10keV,'linewidth',1.8,'Color','green'); axis tight;
ylim([0 12]);
xlim([12 24]);
hold off;
...
for x=1:1201   
    Ca44_Eg_12_24_10keV(x)=(Ca44_cs_12_24_10keV(x)+1.2-Ca48_DWT_12_24_10keV(x))*ex_12_24_10keV(x)/Ca48_V1_12_24_10keV(x);
end
...
subplot(4,2,5); stairs(ex_12_24_10keV,Ca42_cs_12_24_10keV+0.1,'linewidth',0.25,'Color','black'); axis tight;

set(gca,'TickLength',[0.03 0.03]);
ylim([0 12]);
ylabel('d^2\sigma/d\OmegadE (mb/srMeV)','FontSize',12);
%xlabel('Excitation energy (MeV)');
title('Retief 42Ca(p,p\prime)  + 0.1 (mb/srMeV)');
text(13,10,'DWT 48Ca','FontSize',11,'Color','green')
hold on;

subplot(4,2,5); plot(ex_DWT_12_24_10keV,Ca48_DWT_12_24_10keV,'linewidth',1.8,'Color','green'); axis tight;
ylim([0 12]);
xlim([12 24]);
hold off;
...
for x=1:1201   
    Ca42_Eg_12_24_10keV(x)=(Ca42_cs_12_24_10keV(x)+0.1-Ca48_DWT_12_24_10keV(x))*ex_12_24_10keV(x)/Ca48_V1_12_24_10keV(x);
end
...
figure (750);
subplot(4,2,7); stairs(ex_12_24_10keV,Ca40_cs_12_24_10keV+1.8,'linewidth',0.25,'Color','black'); axis tight;

set(gca,'TickLength',[0.03 0.03]);
ylim([0 12]);
ylabel('d^2\sigma/d\OmegadE (mb/srMeV)','FontSize',12);
xlabel('Excitation energy (MeV)','FontSize',14);
title('Max 40Ca(p,p\prime)  + 1.8 (mb/srMeV)');
text(13,10,'DWT 48Ca','FontSize',11,'Color','green')
hold on;


subplot(4,2,7); plot(ex_DWT_12_24_10keV,Ca48_DWT_12_24_10keV,'linewidth',1.8,'Color','green'); axis tight;
ylim([0 12]);
xlim([12 24]);
hold off;
...
for x=1:1201   
    Ca40_Eg_12_24_10keV(x)=(Ca40_cs_12_24_10keV(x)+1.8-Ca48_DWT_12_24_10keV(x))*ex_12_24_10keV(x)/Ca48_V1_12_24_10keV(x);
end
