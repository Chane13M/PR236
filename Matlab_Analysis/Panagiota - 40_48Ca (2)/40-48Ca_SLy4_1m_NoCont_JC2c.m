...
subplot(4,2,6); plot(ex_12_24_10keV,Ca40_P4NCEx_12_24_10keV,'linewidth',1.8,'Color','blue'); axis tight;
set(gca,'TickLength',[0.03 0.03]);
ylim([0 650]);
ylabel('B(E1)*E_x (e^2fm^2)');
%xlabel('Excitation energy (MeV)');
...
subplot(4,2,6); plot(ex_12_24_10keV,Ca48_P4NCEx_12_24_10keV,'linewidth',1.8,'Color','blue'); axis tight;
set(gca,'TickLength',[0.03 0.03]);
ylim([0 650]);
ylabel('B(E1)*E_x (e^2fm^2)');
%xlabel('Excitation energy (MeV)');
...
subplot(4,2,4); plot(ex_12_24_10keV,Ca40_CRPAEx_12_24_10keV,'linewidth',1.8,'Color','red'); axis tight;
set(gca,'TickLength',[0.03 0.03]);
ylim([0 90]);
ylabel('B(E1)*E_x (e^2fm^2)');
%xlabel('Excitation energy (MeV)');
...
subplot(4,2,4); plot(ex_12_24_10keV,Ca48_CRPAEx_12_24_10keV,'linewidth',1.8,'Color','red'); axis tight;
set(gca,'TickLength',[0.03 0.03]);
ylim([0 90]);
ylabel('B(E1)*E_x (e^2fm^2)');
%xlabel('Excitation energy (MeV)');
...
figure (100);
subplot(4,1,4); stairs(ex_8_26_10keV,Ca40_cs_8_26_10keV,'linewidth',1.0,'Color','black'); axis tight;
...
figure (100);
subplot(4,1,3); stairs(ex_8_26_10keV,Ca42_cs_8_26_10keV,'linewidth',1.0,'Color','black'); axis tight;
...
figure (100);
subplot(4,1,2); stairs(ex_8_26_10keV,Ca44_cs_8_26_10keV,'linewidth',1.0,'Color','black'); axis tight;
...
figure (100);
subplot(4,1,1); stairs(ex_8_26_10keV,Ca48_cs_8_26_10keV,'linewidth',1.0,'Color','black'); axis tight;
...
subplot(4,1,4); stairs(ex_12_24_10keV,Ca40_cs_12_24_10keV,'linewidth',1.8,'Color','black'); axis tight;
...
figure (105);
%subplot(4,2,2); stairs(ex_12_24_10keV,Ca40_cs_BkgSub_12_24_10keV,'linewidth',1.8,'Color','black'); axis tight;
subplot(4,1,3); stairs(ex_12_24_10keV,Ca42_cs_12_24_10keV,'linewidth',1.8,'Color','black'); axis tight;
...
figure (105);
%subplot(4,2,2); stairs(ex_12_24_10keV,Ca40_cs_BkgSub_12_24_10keV,'linewidth',1.8,'Color','black'); axis tight;
subplot(4,1,2); stairs(ex_12_24_10keV,Ca44_cs_12_24_10keV,'linewidth',1.8,'Color','black'); axis tight;
...
figure (105);
subplot(4,1,1); stairs(ex_12_24_10keV,Ca48_cs_12_24_10keV,'linewidth',1.8,'Color','black'); axis tight;
set(gca,'TickLength',[0.03 0.03]);
ylim([0 12]);
ylabel('d^2\sigma/d\OmegadE (mb / sr MeV)');
xlabel('Excitation energy (MeV)');
